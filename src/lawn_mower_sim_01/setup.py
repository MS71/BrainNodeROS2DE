"""lawn_mower_sim_01 setup file."""

from setuptools import setup
from glob import glob


package_name = 'lawn_mower_sim_01'
data_files = []
...
setup(
    ...
    entry_points={
        'console_scripts': [
            'driver = lawn_mower_sim_01.driver:main',
            'drive_calibrator = lawn_mower_sim_01.drive_calibrator:main',
            'simple_mapper = lawn_mower_sim_01.simple_mapper:main'
        ],
